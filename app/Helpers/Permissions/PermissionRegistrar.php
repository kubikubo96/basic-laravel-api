...
class PermissionRegistrar
{
    ...
    {
        app(\Illuminate\Contracts\Auth\Access\Gate::class)->before(function (Authorizable $user, string $ability) {
    ...
    public function setPermissionClass($permissionClass)
    {
        ...
        app()->bind(\App\Models\Permission::class, $permissionClass);
    ...
    public function setRoleClass($roleClass)
    {
        ...
        app()->bind(\App\Models\Role::class, $roleClass);
